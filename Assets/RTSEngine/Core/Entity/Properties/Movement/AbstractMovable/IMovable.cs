...
namespace RTSEngine.Core.Movement
{
    ...
    /// <summary>
    /// Required to Enqueue either a point in the world or an <see cref="RTSBehaviour"/> that may change position.
    /// </summary>
    ...
    /// <summary>
    /// Derivative of <see cref="Destination"/> that holds a reference to a <see cref="RTSBehaviour"/> position.
    /// </summary>
    public class Follow : Destination
    {
        public RTSBehaviour entity;       
